...
import styles from "./NewQuestionModal.module.css";
import useUserInfo from "../../../../../utils/getUserIp";
// import QuestionOptionsBox from "./NewQuestionOptionsBox";
import {
    setbuyerRequestData,
...
const NewQuestionModal = ({
    ...
    const handleCloseClick = () => {
      ...
      const hasOtherOption = formattedQuestions[currentQuestion]?.parsedAnswers.some(
  ...
  const currentOptions =
    ...
    hasOtherOption && selectedOption.includes("Something else (please describe)");
    ...
    return (
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Other Textarea — normal (alongside other options) */}
            {showOtherInput && !isOnlyOther && (
            ...
            {/* Other Textarea — isOnlyOther */}
            {showOtherInput && isOnlyOther && (
              <div className={styles.otherInputWrapperOnly}>
                <textarea
                  rows={3}
                  placeholder="Please write text"
                  onChange={(e) => {
