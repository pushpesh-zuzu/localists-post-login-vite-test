...
import styles from "./NewSeeMyMatcheModal.module.css";
...
function NewSeeMyMatcheModal({ previousStep, progressPercent }) {
...
export default NewSeeMyMatcheModal;